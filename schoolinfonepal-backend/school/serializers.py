...
class SchoolSerializer(serializers.ModelSerializer):
    admin_email = serializers.EmailField(source="admin_email", required=False, allow_blank=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'established_date', 'verification', 'featured', 'district', 'level',
            'level_text', 'type', 'facilities', 'universities', 'website', 'priority',
            'map_link', 'salient_feature', 'scholarship', 'about_college',
            'meta_title', 'meta_description', 'og_title', 'og_description', 'og_image',
            'created_at', 'updated_at', 'phones', 'emails', 'gallery', 'brochures',
            'social_media', 'faqs', 'messages', 'school_courses', 'inquiries', 'pre_registrations'
        ]
    ...
    def get_inquiries(self, obj):
        inquiries = Inquiry.objects.filter(school=obj).order_by('-created_at')
        return InquirySerializer(inquiries, many=True).data

    def get_pre_registrations(self, obj):
        pre_registrations = PreRegistrationInquiry.objects.filter(school=obj).order_by('-created_at')
    ...
    def create(self, validated_data):
        ...
        # Create school (user is now created by post_save signal)
        ...
        # DO NOT assign user here, it is done by signal!
    ...
    def update(self, instance, validated_data):
        ...
        # User creation/assignment handled by signal and not serializer!
