...
import { fetchLevelsDropdown, fetchUniversitiesDropdown, fetchCoursesDropdown, fetchSchoolsDropdown } from "@/utils/api"
...
export default function AdmissionFilter({ filters, onChange }) {
  ...
  useEffect(() => {
    const loadData = async () => {
      setLoading(true)
      try {
        const [levelsData, universitiesData, coursesData, schoolsData] = await Promise.all([
          fetchLevelsDropdown(),
      ...
      <div className="md:hidden mb-4">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-gray-700">Filter Admissions</span>
          </div>
          {hasActiveFilters && (
